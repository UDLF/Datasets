This repository provides input files for the [Unsupervised Distance Learning Framework (UDLF)](https://github.com/lucasPV/UDLF) considering three different datasets:
